...
const Welcome = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center h-screen bg-gray-100">
      ...
      <img src={aiImage} alt="AI Image" className="w-80 h-auto rounded-full shadow-md mb-8" />
      
        <div class="flex justify-center items-center ">
    <button onClick={discover} class="relative border hover:border-sky-600 duration-500 group cursor-pointer text-sky-50 overflow-hidden h-14 w-56 rounded-md bg-sky-800 p-2 flex justify-center items-center font-extrabold">
